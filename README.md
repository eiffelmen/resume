...
1. 本地安装MacTex
2. 在VsCode中安装LaTex Workshop

如果确定只需要中文简历的话单独克隆 `master` 分支即可, 需要注意的是该分支包含 Adobe 的宋楷黑仿四套中文字体，压缩包约为37MB。[下载地址](https://github.com/eiffelmen/resume.git)

```
git clone https://github.com/eiffelmen/resume.git --branch master --depth 1
```
